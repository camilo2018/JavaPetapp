<%-- 
    Document   : IngresarDenuncia_Adm
    Created on : 23/11/2018, 08:35:44 AM
    Author     : KnokinGm
--%>
...
<html>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link rel="stylesheet" href="../../../PettApp/Administrador/Denuncia/CSS/Estilo.css">
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    ...
    <form action="../../PettApp/Administrador/Denuncia/Consultar_Denuncia.jsp" >
...
<div id="padre">
 ...
 <form action="../../ServletDenuncia" enctype="multipart/form-data" method="Post">
    ...
    <label>Evidencia</label><input id="inp" type="file" name="IMG" >
      ...
      <input type="submit" name="inevid" value="Realizar Denuncia" class="btn btn-primary">
      </div>
    </form>
</div>
</div>
